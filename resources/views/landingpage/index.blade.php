        ...
        <div class="container pb-5">
            <div class="row g-5 align-items-center mb-5">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                    <img class="img-fluid w-100" src="{{ asset('assets/landingpage/img/kepala-sekolah.jpg') }}"
                        alt="">
                </div>
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <div class="owl-carousel owl-theme">
                                            ...
                                            <div class="team-item">
                                                <div class="position-relative overflow-hidden">
                                                    <img class="img-fluid w-100"
                                                        src="{{ asset('assets/landingpage/img/team-2.jpg') }}"
                                                        alt="">
                                    ...
                                    <div class="item">
                                        <div class="shadow-sm border" data-wow-delay="0.3s">
                                            <div class="team-item">
                                                <div class="position-relative overflow-hidden">
                                                    <img class="img-fluid w-100"
                                                        src="{{ asset('assets/landingpage/img/team-3.jpg') }}"
                                                        alt="">
                                                    <div class="team-social">
                                                        <a class="btn btn-square btn-light mx-1" href=""><i
                                                                class="fab fa-facebook-f"></i></a>
                                    ...
                                    <div class="item">
                                        <div class="shadow-sm border" data-wow-delay="0.5s">
                                            <div class="team-item">
                                                <div class="position-relative overflow-hidden">
                                                    <img class="img-fluid w-100"
                                                        src="{{ asset('assets/landingpage/img/team-4.jpg') }}"
                                                        alt="">
                                                    <div class="team-social">
                                                        <a class="btn btn-square btn-light mx-1" href=""><i
                                                                class="fab fa-facebook-f"></i></a>
    ...
    {{-- <div class="container-fluid container-service py-5">
        <div class="container pt-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <p class="mb-5 text-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus
