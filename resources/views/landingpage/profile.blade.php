...
@section('content')
    <div class="container-fluid bg-white py-5">
        <div class="container">
            <h1 class="text-dark">Profile SMP Negeri 2 Kota Cirebon</h1>
            <div class="row my-4">
                <h4 class="text-primary">Sejarah</h4>
                <p class="col-md" style="text-align: justify">
                    ...
                    <br>
                    <br>
                    Jauh sebelum menjadi sekolah favorit yang cukup megah berlantai dengan
                    konstruksi
                    beton
                    bertulang
                    hanyalah
